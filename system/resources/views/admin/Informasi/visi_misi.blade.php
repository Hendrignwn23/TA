...
<div class="card">
	<div class="card-header">
		...
		<h3>Halaman Visi&Misi Sekolah</h3>
	...
	<div class="card-body">
		...
		<div style="float: right;" class="mb-2">
			@include('admin.template.utils.delete', ['url'=>url('admin/visi_misi', $visi_misi->id)])
		</div>
			<iframe src="{{url('public')}}/{{$visi_misi->file}}" style="width:100%; height: 1000px;"></iframe>
		@endforeach
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="{{url('admin/visi_misi')}}" method="post" enctype="multipart/form-data">
      	@csrf
