...
<div class="card">
	<div class="card-header">
		...
		<h3>Halaman Struktur Sekolah</h3>
	...
	<div class="card-body">
		...
		@include('admin.template.utils.delete', ['url'=>url('admin/struktur', $struktur->id)])
		</div>
			<iframe src="{{url('public')}}/{{$struktur->file}}" style="width:100%; height: 1000px;"></iframe>
		@endforeach
	</div>
</div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="{{url('admin/struktur')}}" method="post" enctype="multipart/form-data">
      	@csrf
